...
const Navbar = () => {
  ...
  return (
    <header>
      <div className="flex justify-between items-center gap-5 py-5 border border-gray-700 rounded-full px-5 bg-slate-900">
        <Logo />
        ...
        {/* phone nav */}
        <div className="flex flex-row-reverse z-999 lg:hidden">
